...
# Ijroi JavaScript:
## Mo JavaScriptro bo yakchand roh metavonem ijro kunem:
## • Istifodai consol dar browser
## • Istifodai Node.js
## • bo sokhtani WEB-sahifaho
# Istifodai Consoli TAB-i WEB-brovserho:
## 1.Browserro kushoda tarafi rosti mishkaro pakhsh karda dar tabli barovarda proverit codro pakhsh mekunem ,bad mo boz consolero pakhsh mekunem
# Istifodai Node.js
## 1.Versiyai oxironi Node.js ro guzarondan
## 2.Visual Studio ro kushodan va papkai js-i nav kushodan
## 3.ijroi papkai soxtagiamon
## 4.resultatro didan
# Bo soxtani web-sahifaho
## JavaScript baroi web-sahifahoro interaktivi kardan ast:
## 1.   papkai nav kushodan
## 2.   papkai navi html va js soxtan
## 3.   strokai nishondodai codro navised
...
## 1.nomhoi variableho bo harf,_,$,soxta meshavand 
